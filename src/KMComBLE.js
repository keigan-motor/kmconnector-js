...
class KMComBLE extends KMComBase{
     ...
     * 定数
     ********************************************/
    //サービスUUID info::nobleはID間のハイフン無し
    ...
    static get MOTOR_BLE_CRS(){
        return {
            'MOTOR_CONTROL':'f140000189364d35a0eddfcd795baa8c',//モーターへの設定、制御命令を取り扱う
            //'MOTOR_LED':'f140000389364d35a0eddfcd795baa8c',//モーターのLEDを取り扱う info:: MOTOR_CONTROL::bleLedで代用
            'MOTOR_MEASUREMENT':'f140000489364d35a0eddfcd795baa8c',//モーターの位置・速度・トルク等測定値を取り扱う
            'MOTOR_IMU_MEASUREMENT':'f140000589364d35a0eddfcd795baa8c',//モーターの加速度・ジャイロセンサー（IMU）を取り扱う
            'MOTOR_SETTING':'f140000689364d35a0eddfcd795baa8c'//モーターの設定値を取り扱う
        };
    }
