...
class KMComWebBLE extends KMComBase{
    ...
    constructor(){
        ...
        this._MOTOR_BLE_CRS={
            ...
            'MOTOR_LOG':'f1400002-8936-4d35-a0ed-dfcd795baa8c'//::info::新
        };
                    ...
                    this._characteristics['MOTOR_MEASUREMENT'].startNotifications().then(obj=>{
                       if(this._characteristics['MOTOR_IMU_MEASUREMENT']){
                        ...
                        if(this._characteristics['MOTOR_LOG']){
                            this._characteristics['MOTOR_LOG'].removeEventListener('characteristicvaluechanged',this._onBleMotorLog);
                            this._characteristics['MOTOR_LOG'].addEventListener('characteristicvaluechanged',this._onBleMotorLog);
                            return this._characteristics['MOTOR_LOG'].startNotifications();
                        }
                    }).then(obj=>{
